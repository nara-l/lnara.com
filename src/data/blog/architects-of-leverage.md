---
title: "Architects of Leverage"
description: "How stuck systems change when people find leverage."
pubDatetime: 2025-12-27T02:36:05.000Z
author: "Lawrence Nara"
tags: ["ideas", "systems", "strategy", "agency", "change"]
draft: false
timezone: "UTC"
audio: "/audio/architects-of-leverage.mp3"
---

Every year, twice a year, we move the clocks. Daylight saving time. Everyone hates it. Doctors say it causes heart attacks. Economists say it costs billions. Every March and November, the smartest people on Twitter write threads explaining why it's insane. Politicians promise to end it.
...
<aside class="callout">
  <p><strong>Collective stuckness:</strong> everyone agrees the outcome is bad, but no single person can change it alone.</p>
</aside>
...
For more examples, see [The List](/posts/the-list).
...
Third, someone benefits. Daylight saving time has [lobbyists](https://savestandard.medium.com/lobbies-699a73a888ad). The healthcare enrollment system employs thousands of people. Tipping lets employers shift payroll costs to customers. For every stuck system, there's usually someone extracting value from the stuckness. They don't want change.
...
<aside class="callout">
  <p><strong>Key point:</strong> collective problems do not yield to individual brilliance. They yield to leverage.</p>
</aside>
...
Consider banking. Starting a business used to require weeks of paperwork to accept payments. Banks moved slowly because they had no competition. Then [Stripe](https://stripe.com) built an API that let any developer accept payments with a few lines of code. It didn't fix banks. It routed around them. That's leverage.
...
<aside class="callout">
  <p><strong>Permissionless leverage:</strong> build, ship, and let adoption coordinate people for you.</p>
</aside>
...
<aside class="callout">
  <p><strong>The reframe:</strong> you stop trying to move the crowd directly. You redesign the setting so the crowd moves itself.</p>
</aside>
...
*For the full inventory of stuck systems, see [The List](/posts/the-list).*

*I'm exploring [agency](/tags/agency), [systems](/tags/systems), and how [change](/tags/change) actually happens.*
